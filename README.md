...
ParentsCC is a web app designed specifically for students of a Specific Uni. It provides a minimalist experience to help students access campus-related resources and tools. e.
...
To run ParentsCC locally:

1. **Clone the repository:**

   ```bash
   git clone https://github.com/Arya4930/ParentsCC.git
   cd ParentsCC
   ```
