    ...
    return (
        <div className="fixed inset-0 z-50 bg-gray-100 dark:bg-slate-900 midnight:bg-black bg-opacity-95 flex flex-col items-center justify-start overflow-y-auto p-6">
            ...
            <div className="w-full max-w-3xl space-y-4 text-gray-700 dark:text-gray-300 midnight:text-gray-200 text-sm leading-relaxed">
                <p>
                    This Privacy Policy describes how <strong>Parent CC</strong> handles data when you use the app.
                </p>
                ...
                <p>
                    <strong>Parent CC</strong> uses <strong>Vercel Analytics</strong> and <strong>Google Analytics</strong>
                ...
                <p>
                    Parent CC does not track users, create profiles, sell data, or share analytics with any third party.
                ...
                <p>
                    <strong>Parent CC</strong> is an <strong>open-source project</strong> created for learning and
