    ...
    return (
        <div className="fixed inset-0 z-50 bg-gray-100 dark:bg-slate-900 midnight:bg-black bg-opacity-95 flex flex-col items-center justify-start overflow-y-auto p-6">
            ...
            <div className="w-full max-w-3xl space-y-4 text-gray-700 dark:text-gray-300 midnight:text-gray-200 text-sm leading-relaxed">
                <p>
                    Welcome to <strong>Parent CC</strong>. By using this application, you agree to the following Terms of Service.
                ...
                <p>
                    <strong>Parent CC</strong> is an experimental web application created solely for educational and personal
                ...
                <p>
                    <strong>Parent CC</strong> is a free and non-commercial project. The developer does not earn revenue,
